...
def anmrr(x_features: np.ndarray, y: np.ndarray, pairwise_distance: Callable[[np.ndarray], np.ndarray], K: float = 2.) -> float:
    ...
    -------
    float
        a value between 0 and 1 where lower values indicate better retrieval performance.
    """
